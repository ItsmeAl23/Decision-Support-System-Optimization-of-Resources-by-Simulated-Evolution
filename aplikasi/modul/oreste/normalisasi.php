<div class="content">
    <h1 class="judul-content">Tabel Normalisasi Data</h1>
    <br>
...
<script>
    ...
    <br>
    <div class="btn-bawah">
        <a class="kembali-btn" href="./?page=oreste&act=besson_rank">Kembali</a>
        <button class="proses-btn" type="button" onclick="window.location.href='./?page=oreste&act=distance_score'">Lanjutkan</button>
    </div>
</div>
